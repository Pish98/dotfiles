...
static const Key keys[] = {
	...
	/* Video */
	{ MODKEY|ShiftMask,             XK_o,       spawn,          SHCMD("xrandr --output $M1 --auto --output $M2 --left-of $M1 --auto; hsetroot -solid '#FFFFFF'")}, // diff
	{ MODKEY,			XK_o,       spawn,          SHCMD("xrandr --output $M1 --off --output $M2 --rate 75 --mode 1920x1080")}, // gaming
